    ...
    <>
        <nav className={`${darkMode?"bg-customDark text-customWhite":"bg-customLight text-customBlack"} flex justify-between items-center py-2 px-5`}>
            ...
            <div className='flex gap-5'>
                ...
                {/* USER ACCOUNT ICON */}
                <svg onClick={toggleSettingbar} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:cursor-pointer" >
