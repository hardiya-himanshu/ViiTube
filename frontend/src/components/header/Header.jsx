  ...
  return (
    <>
        <nav className={`${darkMode?"bg-customDark text-customWhite":"bg-customLight text-customBlack"} flex justify-between items-center py-2 px-5`}>
            ...
            <div >
                <img src="/viitube-logo.png" width='150px' alt="viitube-logo" />
            </div>
            <div className='flex gap-5'>
                ...
                {/* THEME CHANGE ICON */}
                {darkMode?
                <svg onClick={onToggleTheme} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:cursor-pointer">
                ...
                {/* USER ACCOUNT ICON */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:cursor-pointer" onClick={()=>{setUserIconClicked(!userIconClicked)}}>
