...
function Sidebar({darkMode, isSidebarVisible, toggleSidebar}) {
  ...
  return (
    <div className={`${darkMode?"bg-customDark text-customWhite":"bg-customLight text-customBlack"} ${isSidebarVisible?"transform translate-x-0 transition-transform duration-200 ease-in-out":"transform -translate-x-full left-0 transition-transform duration-500 ease-in-out"} min-w-40  absolute w-2/12 top-0 h-full z-30`}>
